...
public class Main extends Application {
    ...
    private Parent createContent() {
                ...
                public void handle(ActionEvent actionEvent) {
                    if (gameStart) {
                        if (player2turn) {
                            ...
                            randResult.setText(String.valueOf(rand));
                            movePlayer2();
                            movePlayer(player_2_XPos, player_2_YPos, player2);
                            player2turn = false;
                            player3turn = true;
                        }
                    }
                ...
                public void handle(ActionEvent actionEvent) {
                    if (gameStart) {
                        if (player3turn) {
                            ...
                            randResult.setText(String.valueOf(rand));
                            movePlayer3();
                            movePlayer(player_3_XPos, player_3_YPos, player3);
                            player3turn = false;
                            player4turn = true;
                        }
                    }
                ...
                public void handle(ActionEvent actionEvent) {
                    if (gameStart) {
                        if (player4turn) {
                            ...
                            randResult.setText(String.valueOf(rand));
                            movePlayer4();
                            movePlayer(player_4_XPos, player_4_YPos, player4);
                            player4turn = false;
                            player1turn = true;
                        }
                    }
        ...
        tileGroup.getChildren().addAll(player1, player2, player3, player4, button, button2, button3, button4, gameButton, randResult);
        return root;
    }
    ...
    private void movePlayer2() {
        for (int i = 0; i < rand; i++) {
            ...
            if (player_2_XPos < 40 || player_2_YPos < 40) {
                player_2_XPos = 40;
                player_2_YPos = 40;
                randResult.setText("Player 2 Score: ");
            }
        }
    }
    ...
    private void movePlayer3() {
        for (int i = 0; i < rand; i++) {
            ...
            if (player_3_XPos < 40 || player_1_YPos < 40) {
                player_3_XPos = 40;
                player_3_YPos = 40;
                randResult.setText("Player 3 Score: ");
            }
        }
    }
    ...
    private void movePlayer4() {
        for (int i = 0; i < rand; i++) {
            ...
            if (player_4_XPos < 40 || player_1_YPos < 40) {
                player_4_XPos = 40;
                player_4_YPos = 40;
                randResult.setText("Player 4 Score: ");
            }
        }
    }
